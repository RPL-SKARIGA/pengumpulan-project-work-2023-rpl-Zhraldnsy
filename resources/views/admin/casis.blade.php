@extends ('layout.side')
@section('tittle', 'Data Calon Siswa')
    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            <div class="d-flex align-items-center">
                ...
                <h2 class="fs-2 m-0 primary-text">Data Calon Siswa</h2>
            </div>
                    ...
                    <tbody>
                        @foreach ($calonsiswa as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">{{$item->gender}}</div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">{{$item->tempat_lahir}}</div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">{{$item->tanggal_lahir}}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="casis-edit/{{$item->id}}" class="btn btn-outline-warning btn-sm">Aksi</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
